...
If you click the bookmark and all the results are "NaN" then sign into your Ovo account again at [Ovo login page](https://my.ovoenergy.com/login) then you can click the bookmark again or refresh the page if it's already open.
